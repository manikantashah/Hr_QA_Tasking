...
def scheduling_flow(
    ...
    if not requisition_number:
                ...
                for suggestion in raw_suggestions:
                    ...
                    # ----------------------------------------
                        ...
                        value = (
                            ...
                            or suggestion.get("matched_title")
                            or suggestion.get("suggested_title")
                        )
        ...
        if title_status == "EXACT":
            ...
            # ------------------------------------------------
            # Store canonical title as a list
            # ------------------------------------------------
